...
class Part3 extends Component{
    ...
    render(){
        return(
            <div>
                <h2>Part3</h2>
                <p className="para"><span className="direction-part">Directions </span>: You will hear some conversations between two people. You will be asked to answer three questions about what the speakers say in each conversation. Select the best response to each question and mark the letter (A), (B), (C), or (D) on your answer sheet. The conversations will not be printed in your test book and will be spoken only one time.</p>
                {
    ...
    componentDidMount(){
        ...
        axios.post('/getPart3',{testNumber})
        .then((res)=>{
          this.state = {
              data: res.data,
